    ...
    <div class="container">
      <div class="row">
			<div class="col-md-5 mx-auto">
                  ...
                  $table="supervisors";
                  $id=$_GET["id"];
                  $query="Select * from $table where sup_id=$id";
                  $result=$conn->query($query);
                  if ($result->num_rows>0)
                    $row = $result -> fetch_row();
                  ?>
                  <form action="update2_sup.php?id=<?php echo $row[0]; ?>"  method="post" name="details" id="details">
					...
					<div class="input-group form-group">
						...
						<input type="password" name="password" value="<?php echo $row[6]; ?>" class="form-control" placeholder="Enter Password">
                           ...
                           <option value="" disabled selected>Select Your Campus</option>
                                 <option value="Faisalabad" <?php if ($row[9]=="CFD"){ echo "selected"; } ?> >CFD</option>
                                <option value="Islamabad" <?php if ($row[9]=="Islamabad"){ echo "selected"; } ?>>Islamabad</option>
                                <option value="Karachi" <?php if ($row[9]=="Karachi"){ echo "selected"; } ?>>Karachi</option>
                                <option value="Lahore" <?php if ($row[9]=="Lahore"){ echo "selected"; } ?>>Lahore</option>
                                <option value="Peshawar" <?php if ($row[9]=="Peshawar"){ echo "selected"; } ?>>Peshawar</option>
                                </select>
                           </div>
